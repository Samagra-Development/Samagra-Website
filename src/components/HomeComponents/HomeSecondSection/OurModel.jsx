...
export class OurModelSection extends React.Component {
  ...
  render() {
    ...
    console.log("jkjkjkjkjkjk",homeContent)
    return (
      <div className={'home-second-section-wrapper'}>
        ...
        <div style={{position:"relative"}}><div style={{marginTop:"64px", padding:"64px 0"}}>
          ...
          <div className='section-description' style={{ padding:"16px 124px 48px 124px", fontSize:"31.5px"}}>{homeContent?.ourApproach?.description}</div>
          <div style={{ display:"flex", alignItems:"center",justifyContent:"center",width:"100%"}}>
            <div style={{width:"54vw",height:"45vw"}}>
                <video
                  ...
                  >
                  <source src={homeContent?.ourApproach?.approachVideo?.publicURL} type="video/mp4" />
