    ...
    <div className={"footer-wrapper"}>
      <div style={{ padding: "0 8.5vw" }}>
        <nav className="nav-wrapper nav justify-content-between align-items-center">
            ...
            <div>
              ...
              >
                <img
                  className={"logo"}
                  src={logoColored}
                  style={{ width: "240px", height: "56.657px" }}
                />
              </a>
            </div>
            <div>
          ...
          <div
            className={"nav"}
            style={{ display: "flex", gap: "28px", padding: "28px 0" }}
          >
            <div
            ...
            >
              ...
              <div>
                <Link to={"/amritseries"}>
                  <span className="footer-item">Amrit Series</span>
                </Link>
              </div>
              <div>
                <Link to={"/decluttered"}>
                  <span className="footer-item">Governance Decluttered</span>
                </Link>
              </div>
              <div>
                <Link to={"/governanceframeworks"}>
                  <span className="footer-item">Governance Frameworks</span>
                </Link>
              </div>
              <div>
                <Link to={"/sushasan"}>
                  <span className="footer-item">Sushasan</span>
                </Link>
              </div>
            </div>
            <div
                ...
                <div style={{ display: "flex", gap: "20px" }}>
                  ...
                  <div>
                    <img
                      ...
                      onClick={() => {
                        window.location.href =
                          "https://www.instagram.com/samagragovernance/?hl=en";
                      }}
                  ...
                  <div>
                    <img
                      ...
                      onClick={() => {
                        window.location.href =
                          "https://www.youtube.com/channel/UCfkXErS-f87xUQkmSKSC8bg";
                      }}
      ...
      <div className={"bottom-copyright"} style={{ opacity: "50%" }}>
        © 2024 Samagra Development Associates Pvt. Ltd &nbsp;&nbsp;{" "}
        <a
          href="https://drive.google.com/file/d/1JBr51LlCtUv-q35Onh6dbgHBmI18qhEH/view?usp=sharing"
          target="_"
          style={{ color: "#1E2833", textDecoration: "underline" }}
        >
          CSR
        </a>
      </div>
