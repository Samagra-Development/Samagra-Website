...
title: "Amrit Series #15: Family ID: From Reactive to Proactive Welfare Delivery"
author: Family ID team
projectId: FAMILY ID
authorImage: /img/images-8-.jpg
date: 2026-06-26T08:12:55.339Z
description: "At the heart of the initiative lies a simple concept: every family
  in Uttar Pradesh receives a unique 12-digit Family ID. Each ID links
  individual family members and enables the government to understand
  relationships, eligibility conditions, and benefit delivery at the family
  level — not just the individual level. This has helped in more targeted
  welfare delivery, improving inclusion of left out eligible families and better
  utilisation of public funds. "
featuredimage: /img/blog-feature-15-.png
---
<!--StartFragment-->
...
* Identity Data: Name, age, gender, address, domicile status, mobile number, and family relationships.
* Eligibility Data: Caste, income, disability status, educational qualifications, occupation, marital status, and landholding information.
* Transaction Data: Benefits received through various welfare schemes.
...
![Image 1: Lists are share on ground via department dashboard Image 2: An official conducting telephonic interview](/img/screenshot-2026-06-26-134835.png "Family ID dashboard and calling ")
...
* Deceased beneficiaries continuing to appear in active lists
* Multiple beneficiaries of the same family receiving benefits under the same scheme
* Households with income-tax paying members enrolled in poverty-linked schemes
* Applicants whose family landholdings exceed scheme thresholds
...
![ Process of removing ineligible citizens from a scheme ](/img/screenshot-2026-06-26-135422.png "Image 3: Process of removing ineligible citizens from a scheme ")
